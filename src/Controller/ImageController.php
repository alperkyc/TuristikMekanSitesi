...
class ImageController extends AbstractController
{
   ...
   * @return string
    */
    ...
    /**
     * @Route("/{id}/{pid}", name="user_image_delete", methods={"DELETE"})
     */
    public function delete(Request $request,$id,$pid, Image $image): Response
    {
        ...
        return $this->redirectToRoute('user_image_new',['id'=>$pid]);
    }
}
